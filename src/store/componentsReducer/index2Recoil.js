...
import { getNextSelectedId, insertNewComponent } from './utils2'
...
export const componentsSlice = createSlice({
  ...
  reducers: {
    ...
    // 修改 selectedId
    changeSelectedId: produce((draft, action) => {
    ...
    // 修改组件属性
    changeComponentProps: produce((draft, action) => {
    ...
    // 删除选中的组件
    removeSelectedComponent: produce((draft) => {
    ...
    // 锁定/解锁 组件
    toggleComponentLocked: produce((draft, action) => {
    ...
    // 粘贴组件
    pasteCopiedComponent: produce((draft) => {
    ...
    // 修改组件标题
    changeComponentTitle: produce((draft, action) => {
    ...
    // 移动组件位置
    moveComponent: produce((draft, action) => {
